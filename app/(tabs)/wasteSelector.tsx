...
const categories: WasteCategory[] = [
  ...
  },
  {
    ...
    name: "Scrap Metal",
    points: 65,
    image: 'https://www.recyclingdepotadelaide.com.au/images/recycling/scrap-metal-recycling-process.jpg',
    description: "Recyclable metal scraps.",
    rules: ["Remove non-metal parts", "Sort by type", "Handle safely"],
  },
  {
    id: "10",
    name: "Non-Recyclable",
